...
def run_replay(commanded_poses, achieved_poses, Kp, Kd):
    ...
    try:
        for cnt in range(len(commanded_poses)):
            ...
            controller.set("q_desired", target[:7])
...
if __name__ == "__main__":
    ...
    achieved_real, achieved_vels_real, achieved_torques_real = run_replay(commanded_poses, achieved_poses, args.Kp, args.Kd)
